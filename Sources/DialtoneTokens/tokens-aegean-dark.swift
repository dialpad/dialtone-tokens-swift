...
public enum DialtoneTokensAegeanDark {
    ...
    public static let dtShellActionColorBackgroundMutedActive = UIColor(red: 0.957, green: 0.710, blue: 0.624, alpha: 0.071)
    public static let dtShellActionColorBackgroundMutedDefault = UIColor(red: 0.957, green: 0.710, blue: 0.624, alpha: 0.051)
    public static let dtShellActionColorBackgroundMutedHover = UIColor(red: 0.957, green: 0.710, blue: 0.624, alpha: 0.102)
    public static let dtShellActionColorBackgroundMutedSelected = UIColor(red: 0.957, green: 0.710, blue: 0.624, alpha: 0.071)
    public static let dtShellActionColorBackgroundPrimaryActive = UIColor(red: 0.957, green: 0.710, blue: 0.624, alpha: 0.161)
    public static let dtShellActionColorBackgroundPrimaryDefault = UIColor(red: 0.957, green: 0.710, blue: 0.624, alpha: 0)
    public static let dtShellActionColorBackgroundPrimaryHover = UIColor(red: 0.957, green: 0.710, blue: 0.624, alpha: 0.102)
    public static let dtShellActionColorBackgroundPrimarySelected = UIColor(red: 0.957, green: 0.710, blue: 0.624, alpha: 0.129)
    public static let dtShellActionColorBackgroundSecondaryActive = UIColor(red: 0.957, green: 0.710, blue: 0.624, alpha: 0.161)
    public static let dtShellActionColorBackgroundSecondaryDefault = UIColor(red: 0.957, green: 0.710, blue: 0.624, alpha: 0)
    public static let dtShellActionColorBackgroundSecondaryHover = UIColor(red: 0.957, green: 0.710, blue: 0.624, alpha: 0.102)
    public static let dtShellActionColorBackgroundSecondarySelected = UIColor(red: 0.957, green: 0.710, blue: 0.624, alpha: 0.129)
    public static let dtShellActionColorForegroundMutedActive = UIColor(red: 0.435, green: 0.180, blue: 1.000, alpha: 0.600)
    public static let dtShellActionColorForegroundMutedDefault = UIColor(red: 0.976, green: 0.965, blue: 1.000, alpha: 0.600)
    public static let dtShellActionColorForegroundMutedHover = UIColor(red: 0.435, green: 0.180, blue: 1.000, alpha: 0.600)
    public static let dtShellActionColorForegroundMutedSelected = UIColor(red: 0.247, green: 0.000, blue: 0.784, alpha: 0.600)
    public static let dtShellActionColorForegroundPrimaryDefault = UIColor(red: 0.976, green: 0.965, blue: 1.000, alpha: 0.859)
    public static let dtShellActionColorForegroundPrimaryDisabled = UIColor(red: 0.976, green: 0.965, blue: 1.000, alpha: 0.569)
    public static let dtShellActionColorForegroundPrimaryStrong = UIColor(red: 0.996, green: 0.992, blue: 1.000, alpha: 1)
    public static let dtShellActionColorForegroundSecondaryDefault = UIColor(red: 0.976, green: 0.965, blue: 1.000, alpha: 0.859)
    public static let dtShellActionColorForegroundSecondaryDisabled = UIColor(red: 0.976, green: 0.965, blue: 1.000, alpha: 0.569)
    public static let dtShellActionColorForegroundTertiaryDefault = UIColor(red: 0.976, green: 0.965, blue: 1.000, alpha: 0.722)
    ...
    public static let dtShellColorForegroundDisabled = UIColor(red: 0.976, green: 0.965, blue: 1.000, alpha: 0.569)
    public static let dtShellColorForegroundMuted = UIColor(red: 0.976, green: 0.965, blue: 1.000, alpha: 0.600)
    public static let dtShellColorForegroundPositive = UIColor(red: 0.518, green: 0.933, blue: 0.043, alpha: 1)
    public static let dtShellColorForegroundPrimary = UIColor(red: 0.976, green: 0.965, blue: 1.000, alpha: 1)
    public static let dtShellColorForegroundSecondary = UIColor(red: 0.976, green: 0.965, blue: 1.000, alpha: 0.859)
