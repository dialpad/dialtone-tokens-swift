...
public enum DialtoneTokensButtercreamDark {
    ...
    public static let dtShellActionColorForegroundMutedActive = UIColor(red: 0.349, green: 0.792, blue: 0.765, alpha: 0.600)
    public static let dtShellActionColorForegroundMutedDefault = UIColor(red: 0.925, green: 0.976, blue: 0.973, alpha: 0.600)
    public static let dtShellActionColorForegroundMutedHover = UIColor(red: 0.349, green: 0.792, blue: 0.765, alpha: 0.600)
    public static let dtShellActionColorForegroundMutedSelected = UIColor(red: 0.184, green: 0.576, blue: 0.553, alpha: 0.600)
    public static let dtShellActionColorForegroundPrimaryDefault = UIColor(red: 0.925, green: 0.976, blue: 0.973, alpha: 0.859)
    public static let dtShellActionColorForegroundPrimaryDisabled = UIColor(red: 0.925, green: 0.976, blue: 0.973, alpha: 0.569)
    public static let dtShellActionColorForegroundPrimaryStrong = UIColor(red: 0.984, green: 0.996, blue: 0.996, alpha: 1)
    public static let dtShellActionColorForegroundSecondaryDefault = UIColor(red: 0.925, green: 0.976, blue: 0.973, alpha: 0.859)
    public static let dtShellActionColorForegroundSecondaryDisabled = UIColor(red: 0.925, green: 0.976, blue: 0.973, alpha: 0.569)
    public static let dtShellActionColorForegroundTertiaryDefault = UIColor(red: 0.925, green: 0.976, blue: 0.973, alpha: 0.722)
    ...
    public static let dtShellColorForegroundDisabled = UIColor(red: 0.925, green: 0.976, blue: 0.973, alpha: 0.569)
    public static let dtShellColorForegroundMuted = UIColor(red: 0.925, green: 0.976, blue: 0.973, alpha: 0.600)
    public static let dtShellColorForegroundPositive = UIColor(red: 0.518, green: 0.933, blue: 0.043, alpha: 1)
    public static let dtShellColorForegroundPrimary = UIColor(red: 0.925, green: 0.976, blue: 0.973, alpha: 1)
    public static let dtShellColorForegroundSecondary = UIColor(red: 0.925, green: 0.976, blue: 0.973, alpha: 0.859)
