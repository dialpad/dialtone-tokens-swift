...
public enum DialtoneTokensExpressiveSmDark {
    ...
    public static let dtShellMentionColorSurfacePrimary = UIColor(red: 0.733, green: 0.651, blue: 0.988, alpha: 1)
    public static let dtShellMentionColorSurfaceSecondary = UIColor(red: 0.910, green: 0.875, blue: 1.000, alpha: 1)
