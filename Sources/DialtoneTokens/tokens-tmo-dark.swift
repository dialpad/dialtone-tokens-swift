...
public enum DialtoneTokensTmoDark {
    ...
    public static let dtThemeSidebarRowColorBackground = UIColor(red: 0.949, green: 0.522, blue: 0.737, alpha: 0)
    public static let dtThemeSidebarRowColorBackgroundActive = UIColor(red: 0.949, green: 0.522, blue: 0.737, alpha: 0.239)
    public static let dtThemeSidebarRowColorBackgroundHover = UIColor(red: 0.949, green: 0.522, blue: 0.737, alpha: 0.180)
    public static let dtThemeSidebarSectionColorForeground = UIColor(red: 0.667, green: 0.667, blue: 0.667, alpha: 1)
    public static let dtThemeSidebarSelectedRowColorBackground = UIColor(red: 0.949, green: 0.522, blue: 0.737, alpha: 0.200)
    ...
    public static let dtThemeTopbarButtonColorBackground = UIColor(red: 0.949, green: 0.522, blue: 0.737, alpha: 0)
    public static let dtThemeTopbarButtonColorBackgroundActive = UIColor(red: 0.949, green: 0.522, blue: 0.737, alpha: 0.102)
    public static let dtThemeTopbarButtonColorBackgroundHover = UIColor(red: 0.949, green: 0.522, blue: 0.737, alpha: 0.149)
    public static let dtThemeTopbarButtonColorForeground = UIColor(red: 0.949, green: 0.522, blue: 0.737, alpha: 0.651)
    ...
    public static let dtThemeTopbarColorForeground = UIColor(red: 0.949, green: 0.522, blue: 0.737, alpha: 0.749)
    public static let dtThemeTopbarFieldColorBackground = UIColor(red: 0.949, green: 0.522, blue: 0.737, alpha: 0.051)
    public static let dtThemeTopbarFieldColorBackgroundHover = UIColor(red: 0.102, green: 0.102, blue: 0.102, alpha: 1)
    public static let dtThemeTopbarFieldColorBorder = UIColor(red: 0.949, green: 0.522, blue: 0.737, alpha: 0)
    public static let dtThemeTopbarFieldColorBorderActive = UIColor(red: 0.949, green: 0.522, blue: 0.737, alpha: 0.200)
    public static let dtThemeTopbarFieldColorBorderHover = UIColor(red: 0.949, green: 0.522, blue: 0.737, alpha: 0.102)
    public static let dtThemeTopbarFieldColorForeground = UIColor(red: 0.949, green: 0.522, blue: 0.737, alpha: 0.502)
    public static let dtThemeTopbarFieldColorForegroundHover = UIColor(red: 0.949, green: 0.522, blue: 0.737, alpha: 0.749)
    public static let dtThemeTopbarProfileColorBackground = UIColor(red: 0.949, green: 0.522, blue: 0.737, alpha: 0.051)
    public static let dtThemeTopbarProfileColorBackgroundActive = UIColor(red: 0.949, green: 0.522, blue: 0.737, alpha: 0.141)
    public static let dtThemeTopbarProfileColorBackgroundHover = UIColor(red: 0.949, green: 0.522, blue: 0.737, alpha: 0.102)
    public static let dtThemeTopbarProfileColorBackgroundInverted = UIColor(red: 0.949, green: 0.522, blue: 0.737, alpha: 0.749)
    public static let dtThemeTopbarProfileColorForeground = UIColor(red: 0.949, green: 0.522, blue: 0.737, alpha: 0.749)
