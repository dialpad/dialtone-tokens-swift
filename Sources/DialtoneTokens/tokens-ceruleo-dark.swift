...
public enum DialtoneTokensCeruleoDark {
    ...
    public static let dtShellActionColorBackgroundMutedActive = UIColor(red: 0.373, green: 0.769, blue: 0.976, alpha: 0.071)
    public static let dtShellActionColorBackgroundMutedDefault = UIColor(red: 0.373, green: 0.769, blue: 0.976, alpha: 0.051)
    public static let dtShellActionColorBackgroundMutedHover = UIColor(red: 0.373, green: 0.769, blue: 0.976, alpha: 0.102)
    public static let dtShellActionColorBackgroundMutedSelected = UIColor(red: 0.373, green: 0.769, blue: 0.976, alpha: 0.071)
    public static let dtShellActionColorBackgroundPrimaryActive = UIColor(red: 0.373, green: 0.769, blue: 0.976, alpha: 0.161)
    public static let dtShellActionColorBackgroundPrimaryDefault = UIColor(red: 0.373, green: 0.769, blue: 0.976, alpha: 0)
    public static let dtShellActionColorBackgroundPrimaryHover = UIColor(red: 0.373, green: 0.769, blue: 0.976, alpha: 0.102)
    public static let dtShellActionColorBackgroundPrimarySelected = UIColor(red: 0.373, green: 0.769, blue: 0.976, alpha: 0.129)
    public static let dtShellActionColorBackgroundSecondaryActive = UIColor(red: 0.373, green: 0.769, blue: 0.976, alpha: 0.161)
    public static let dtShellActionColorBackgroundSecondaryDefault = UIColor(red: 0.373, green: 0.769, blue: 0.976, alpha: 0)
    public static let dtShellActionColorBackgroundSecondaryHover = UIColor(red: 0.373, green: 0.769, blue: 0.976, alpha: 0.102)
    public static let dtShellActionColorBackgroundSecondarySelected = UIColor(red: 0.373, green: 0.769, blue: 0.976, alpha: 0.129)
    ...
    public static let dtShellActionColorForegroundPrimaryStrong = UIColor(red: 0.992, green: 0.996, blue: 1.000, alpha: 1)
    ...
    public static let dtShellBaseActionColorBackgroundMuted = UIColor(red: 0.373, green: 0.769, blue: 0.976, alpha: 1)
    public static let dtShellBaseActionColorBackgroundPrimary = UIColor(red: 0.373, green: 0.769, blue: 0.976, alpha: 1)
    public static let dtShellBaseActionColorBackgroundSecondary = UIColor(red: 0.373, green: 0.769, blue: 0.976, alpha: 1)
    public static let dtShellBaseColorAccent = UIColor(red: 1.000, green: 0.443, blue: 0.435, alpha: 1)
    public static let dtShellBaseColorAction = UIColor(red: 0.373, green: 0.769, blue: 0.976, alpha: 1)
    ...
    public static let dtShellColorForegroundCritical = UIColor(red: 1.000, green: 0.525, blue: 0.522, alpha: 1)
    ...
    public static let dtShellColorForegroundPositive = UIColor(red: 0.682, green: 0.984, blue: 0.235, alpha: 1)
    ...
    public static let dtShellColorForegroundStrong = UIColor(red: 0.992, green: 0.996, blue: 1.000, alpha: 1)
    public static let dtShellColorForegroundTertiary = UIColor(red: 0.961, green: 0.976, blue: 0.992, alpha: 0.722)
    public static let dtShellColorForegroundWarning = UIColor(red: 1.000, green: 0.878, blue: 0.576, alpha: 1)
    ...
    public static let dtShellMentionColorSurfacePrimary = UIColor(red: 1.000, green: 0.443, blue: 0.435, alpha: 1)
    public static let dtShellMentionColorSurfaceSecondary = UIColor(red: 1.000, green: 0.812, blue: 0.792, alpha: 1)
