...
public enum DialtoneTokensSunflowerDark {
    ...
    public static let dtShellActionColorBackgroundMutedActive = UIColor(red: 0.945, green: 0.882, blue: 0.463, alpha: 0.071)
    public static let dtShellActionColorBackgroundMutedDefault = UIColor(red: 0.945, green: 0.882, blue: 0.463, alpha: 0.051)
    public static let dtShellActionColorBackgroundMutedHover = UIColor(red: 0.945, green: 0.882, blue: 0.463, alpha: 0.102)
    public static let dtShellActionColorBackgroundMutedSelected = UIColor(red: 0.945, green: 0.882, blue: 0.463, alpha: 0.071)
    public static let dtShellActionColorBackgroundPrimaryActive = UIColor(red: 0.945, green: 0.882, blue: 0.463, alpha: 0.161)
    public static let dtShellActionColorBackgroundPrimaryDefault = UIColor(red: 0.945, green: 0.882, blue: 0.463, alpha: 0)
    public static let dtShellActionColorBackgroundPrimaryHover = UIColor(red: 0.945, green: 0.882, blue: 0.463, alpha: 0.102)
    public static let dtShellActionColorBackgroundPrimarySelected = UIColor(red: 0.945, green: 0.882, blue: 0.463, alpha: 0.129)
    public static let dtShellActionColorBackgroundSecondaryActive = UIColor(red: 0.945, green: 0.882, blue: 0.463, alpha: 0.161)
    public static let dtShellActionColorBackgroundSecondaryDefault = UIColor(red: 0.945, green: 0.882, blue: 0.463, alpha: 0)
    public static let dtShellActionColorBackgroundSecondaryHover = UIColor(red: 0.945, green: 0.882, blue: 0.463, alpha: 0.102)
    public static let dtShellActionColorBackgroundSecondarySelected = UIColor(red: 0.945, green: 0.882, blue: 0.463, alpha: 0.129)
    public static let dtShellActionColorForegroundMutedActive = UIColor(red: 1.000, green: 0.169, blue: 0.235, alpha: 0.600)
    public static let dtShellActionColorForegroundMutedDefault = UIColor(red: 1.000, green: 0.949, blue: 0.953, alpha: 0.600)
    public static let dtShellActionColorForegroundMutedHover = UIColor(red: 1.000, green: 0.169, blue: 0.235, alpha: 0.600)
    public static let dtShellActionColorForegroundMutedSelected = UIColor(red: 0.780, green: 0.000, blue: 0.063, alpha: 0.600)
    public static let dtShellActionColorForegroundPrimaryDefault = UIColor(red: 1.000, green: 0.949, blue: 0.953, alpha: 0.859)
    public static let dtShellActionColorForegroundPrimaryDisabled = UIColor(red: 1.000, green: 0.949, blue: 0.953, alpha: 0.569)
    public static let dtShellActionColorForegroundPrimaryStrong = UIColor(red: 1.000, green: 0.988, blue: 0.992, alpha: 1)
    public static let dtShellActionColorForegroundSecondaryDefault = UIColor(red: 1.000, green: 0.949, blue: 0.953, alpha: 0.859)
    public static let dtShellActionColorForegroundSecondaryDisabled = UIColor(red: 1.000, green: 0.949, blue: 0.953, alpha: 0.569)
    public static let dtShellActionColorForegroundTertiaryDefault = UIColor(red: 1.000, green: 0.949, blue: 0.953, alpha: 0.722)
    public static let dtShellBaseActionColorBackgroundMuted = UIColor(red: 0.945, green: 0.882, blue: 0.463, alpha: 1)
    public static let dtShellBaseActionColorBackgroundPrimary = UIColor(red: 0.945, green: 0.882, blue: 0.463, alpha: 1)
    public static let dtShellBaseActionColorBackgroundSecondary = UIColor(red: 0.945, green: 0.882, blue: 0.463, alpha: 1)
    public static let dtShellBaseColorAccent = UIColor(red: 0.957, green: 0.525, blue: 0.384, alpha: 1)
    public static let dtShellBaseColorAction = UIColor(red: 0.945, green: 0.882, blue: 0.463, alpha: 1)
    public static let dtShellBaseColorBorder = UIColor(red: 1.000, green: 0.898, blue: 0.902, alpha: 1)
    public static let dtShellBaseColorForeground = UIColor(red: 1.000, green: 0.949, blue: 0.953, alpha: 1)
    ...
    public static let dtShellColorBorderDefault = UIColor(red: 1.000, green: 0.898, blue: 0.902, alpha: 0.180)
    public static let dtShellColorBorderSubtle = UIColor(red: 1.000, green: 0.898, blue: 0.902, alpha: 0.149)
    public static let dtShellColorForegroundCritical = UIColor(red: 1.000, green: 0.369, blue: 0.455, alpha: 1)
    public static let dtShellColorForegroundDisabled = UIColor(red: 1.000, green: 0.949, blue: 0.953, alpha: 0.569)
    public static let dtShellColorForegroundMuted = UIColor(red: 1.000, green: 0.949, blue: 0.953, alpha: 0.600)
    public static let dtShellColorForegroundPositive = UIColor(red: 0.518, green: 0.933, blue: 0.043, alpha: 1)
    public static let dtShellColorForegroundPrimary = UIColor(red: 1.000, green: 0.949, blue: 0.953, alpha: 1)
    public static let dtShellColorForegroundSecondary = UIColor(red: 1.000, green: 0.949, blue: 0.953, alpha: 0.859)
    public static let dtShellColorForegroundStrong = UIColor(red: 1.000, green: 0.988, blue: 0.992, alpha: 1)
    public static let dtShellColorForegroundTertiary = UIColor(red: 1.000, green: 0.949, blue: 0.953, alpha: 0.722)
