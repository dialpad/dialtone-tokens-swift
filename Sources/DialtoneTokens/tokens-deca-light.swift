...
public enum DialtoneTokensDecaLight {
    ...
    public static let dtBadgeColorBackgroundDefault = UIColor(red: 0.808, green: 0.784, blue: 0.769, alpha: 0.659)
    ...
    public static let dtBadgeColorBorderDefault = UIColor(red: 0.114, green: 0.110, blue: 0.106, alpha: 0.110)
    ...
    public static let dtCheckboxColorBorderUnchecked = UIColor(red: 0.114, green: 0.110, blue: 0.106, alpha: 0.302)
    public static let dtCheckboxColorBorderUncheckedHover = UIColor(red: 0.114, green: 0.110, blue: 0.106, alpha: 0.502)
    public static let dtCheckboxColorForegroundChecked = UIColor(red: 0.949, green: 0.941, blue: 0.933, alpha: 1)
    ...
    public static let dtColorBorderDefault = UIColor(red: 0.114, green: 0.110, blue: 0.106, alpha: 0.169)
    public static let dtColorBorderModerate = UIColor(red: 0.114, green: 0.110, blue: 0.106, alpha: 0.302)
    public static let dtColorBorderSubtle = UIColor(red: 0.114, green: 0.110, blue: 0.106, alpha: 0.110)
    public static let dtColorForegroundDisabled = UIColor(red: 0.529, green: 0.502, blue: 0.482, alpha: 1)
    public static let dtColorForegroundDisabledInverted = UIColor(red: 0.667, green: 0.643, blue: 0.631, alpha: 1)
    public static let dtColorForegroundMuted = UIColor(red: 0.043, green: 0.039, blue: 0.035, alpha: 0.549)
    public static let dtColorForegroundMutedInverted = UIColor(red: 0.949, green: 0.941, blue: 0.933, alpha: 0.702)
    public static let dtColorForegroundPlaceholder = UIColor(red: 0.529, green: 0.502, blue: 0.482, alpha: 1)
    public static let dtColorForegroundPlaceholderInverted = UIColor(red: 0.667, green: 0.643, blue: 0.631, alpha: 1)
    public static let dtColorForegroundPrimary = UIColor(red: 0.114, green: 0.110, blue: 0.106, alpha: 1)
    public static let dtColorForegroundPrimaryInverted = UIColor(red: 0.949, green: 0.941, blue: 0.933, alpha: 1)
    public static let dtColorForegroundSecondary = UIColor(red: 0.247, green: 0.239, blue: 0.235, alpha: 1)
    public static let dtColorForegroundSecondaryInverted = UIColor(red: 0.878, green: 0.863, blue: 0.851, alpha: 1)
    public static let dtColorForegroundTertiary = UIColor(red: 0.388, green: 0.373, blue: 0.365, alpha: 1)
    public static let dtColorForegroundTertiaryInverted = UIColor(red: 0.808, green: 0.784, blue: 0.769, alpha: 1)
    ...
    public static let dtColorSurfaceBoldOpaque = UIColor(red: 0.667, green: 0.643, blue: 0.631, alpha: 0.600)
    public static let dtColorSurfaceBoldOpaqueInverted = UIColor(red: 0.529, green: 0.502, blue: 0.482, alpha: 0.722)
    public static let dtColorSurfaceContrast = UIColor(red: 0.157, green: 0.149, blue: 0.141, alpha: 1)
    public static let dtColorSurfaceContrastInverted = UIColor(red: 0.949, green: 0.941, blue: 0.933, alpha: 1)
    public static let dtColorSurfaceContrastOpaque = UIColor(red: 0.114, green: 0.110, blue: 0.106, alpha: 0.949)
    public static let dtColorSurfaceContrastOpaqueInverted = UIColor(red: 0.973, green: 0.969, blue: 0.965, alpha: 0.961)
    public static let dtColorSurfaceModerate = UIColor(red: 0.878, green: 0.863, blue: 0.851, alpha: 1)
    public static let dtColorSurfaceModerateInverted = UIColor(red: 0.247, green: 0.239, blue: 0.235, alpha: 1)
    public static let dtColorSurfaceModerateOpaque = UIColor(red: 0.808, green: 0.784, blue: 0.769, alpha: 0.659)
    public static let dtColorSurfaceModerateOpaqueInverted = UIColor(red: 0.388, green: 0.373, blue: 0.365, alpha: 0.600)
    public static let dtColorSurfacePrimaryInverted = UIColor(red: 0.043, green: 0.039, blue: 0.035, alpha: 1)
    public static let dtColorSurfaceSecondary = UIColor(red: 0.949, green: 0.941, blue: 0.933, alpha: 1)
    public static let dtColorSurfaceSecondaryInverted = UIColor(red: 0.157, green: 0.149, blue: 0.141, alpha: 1)
    public static let dtColorSurfaceSecondaryOpaque = UIColor(red: 0.114, green: 0.110, blue: 0.106, alpha: 0.059)
    public static let dtColorSurfaceSecondaryOpaqueInverted = UIColor(red: 0.247, green: 0.239, blue: 0.235, alpha: 0.549)
    public static let dtColorSurfaceStrong = UIColor(red: 0.388, green: 0.373, blue: 0.365, alpha: 1)
    public static let dtColorSurfaceStrongInverted = UIColor(red: 0.667, green: 0.643, blue: 0.631, alpha: 1)
    public static let dtColorSurfaceStrongOpaque = UIColor(red: 0.247, green: 0.239, blue: 0.235, alpha: 0.820)
    public static let dtColorSurfaceStrongOpaqueInverted = UIColor(red: 0.808, green: 0.784, blue: 0.769, alpha: 0.812)
    ...
    public static let dtRadioColorBorderUnchecked = UIColor(red: 0.114, green: 0.110, blue: 0.106, alpha: 0.302)
    public static let dtRadioColorBorderUncheckedHover = UIColor(red: 0.114, green: 0.110, blue: 0.106, alpha: 0.502)
    public static let dtRadioColorForegroundChecked = UIColor(red: 0.949, green: 0.941, blue: 0.933, alpha: 1)
    ...
    public static let dtThemeColorBase = UIColor(red: 0.114, green: 0.110, blue: 0.106, alpha: 1)
